...
Make sure you change the ```<Your-Lambda-ARN>``` field to your Lambda function's ARN. The Lambda function ARN can be found on your Lambda function from AWS Lambda console window.
